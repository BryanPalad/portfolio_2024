    ...
    content: (
      <div>
        ...
        <div className="flex flex-col mb-4">
          ...
          <h6 className="mb-2 text-sm font-normal md:text-lg">
            Tools used: Git, Bitbucket, Monday.com, Stripo, EmailOnAcid, Trello,
            Wordpress, Elementor, Metabase
          </h6>
        </div>
        ...
        <ul className="list-disc ml-4">
          ...
          <li className="mb-2 text-sm font-normal md:text-lg text-neutral-300">
            Built responsive, high-quality user interfaces with Tailwind CSS and
            Shadcn.
          </li>
          <li className="mb-2 text-sm font-normal md:text-lg text-neutral-300">
          ...
          <li className="mb-2 text-sm font-normal md:text-lg text-neutral-300">
            ...
            Elementor, and implemented SEO best practices using Yoast SEO, with
            ongoing performance monitoring via Google Search Console.
          </li>
        </ul>
      </div>
    ),
  },
  {
    ...
    content: (
      <div>
        ...
        <div className="flex flex-col mb-4">
          <h6 className="mb-2 text-sm font-normal md:text-lg">
            Front-End: Next JS, Typescript, TailwindCSS, Material UI, Turbo Repo
          </h6>
          <h6 className="mb-2 text-sm font-normal md:text-lg">
        ...
        <ul className="list-disc ml-4">
          ...
          <li className="mb-2 text-sm font-normal md:text-lg text-neutral-300">
            Collaborated with distributed teams using GitHub and Postman for API
            Testing.
          </li>
          <li className="mb-2 text-sm font-normal md:text-lg text-neutral-300">
  ...
  },
  {
    ...
    content: (
      <div>
        ...
        <div className="flex flex-col mb-4">
          <h6 className="mb-2 text-sm font-normal md:text-lg">
            Front-End: HTML, CSS, JavaScript ES6, VueJS, Vuex, UniApp, Tailwind
            CSS
          </h6>
          <h6 className="mb-2 text-sm font-normal md:text-lg">
        ...
        <ul className="list-disc ml-4">
          ...
          <li className="mb-2 text-sm font-normal md:text-lg text-neutral-300">
            Collaborated with graphic/web designer to conceptualize the e-Wallet
            design using Figma, translating wireframes into a user-friendly
            interfaces.
          </li>
          <li className="mb-2 text-sm font-normal md:text-lg text-neutral-300">
            Maintained and innovated the Payment Gateway system (SaaS) using
            Java Spring Boot, Spring MVC, MyBatis, Redis, Thymeleaf, and MySQL,
            ensuring efficient and effective tracking of business transactions.
          </li>
          <li className="mb-2 text-sm font-normal md:text-lg text-neutral-300">
            Developed RESTful APIs with Java Spring Boot, utilizing MyBatis for
            data handling and MySQL for queries. Integrated these APIs with the
            e-Wallet using Axios and tested endpoints with Postman.
          </li>
          <li className="mb-2 text-sm font-normal md:text-lg text-neutral-300">
            Payment API Integration from companies like Coins.ph, Bayad Center,
            NetBank, and StarPay. This involved reviewing API documentation,
            ensuring compatibility, and integrating with our payment gateway and
            e-Wallet (PayLoro) using JWT and OAuth 2.0 for secure transactions.
          </li>
          <li className="mb-2 text-sm font-normal md:text-lg text-neutral-300">
            Developed front-end websites, including QRPH, Checkout Counter, and
            PayBills pages, integrating them with our payment gateway and
